...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> sendGetRequest() async {
    ...
    walletId =
        Provider.of<WalletProvider>(context, listen: false).wallet!.wallet_id;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: (walletProvider.wallet?.wallet_id != null)
          ...
          : Container(
              ...
              child: Column(
                ...
                children: [
                  AppLargeText(
                    text: "You are not logged in via Metamask. Please log in.",
                  ),
                  const SizedBox(
                    height: 30,
                  ),
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: AppColors.starColor, width: 1)),
                    child: IconButton(
